...
const PACKS = {
  ...
  fa: {
    ...
    "exp.dogs.toss.title": "نزدیکش یک صدای ناگهانی بساز",
    "exp.dogs.toss.how": "چیزی از میز کناری بردار و پرت کن — نه به سمت او.",
    "exp.dogs.toss.p0": "صدای افتادن دیوانه‌اش می‌کند",
    "exp.dogs.toss.p1": "یکه می‌خورد، بعد آرام می‌گیرد",
    "exp.dogs.toss.p2": "اصلاً اهمیتی نمی‌دهد",
    "exp.dogs.toss.out": "افتاد و صدا داد. او فهمید، و بعد رهایش کرد. صدا اطلاعات است، نه خطر.",
